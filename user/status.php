...
$query= "SELECT eventid,budget,status FROM event WHERE nic='$user'; ";
...
if($qq>0){
	...
	echo "<h3>You don't have created any event yet</h3><br>";
	echo "<form action='party.php'>
			<button type='submit'>Create Event From Here</button>
		</form>";
}
?>
</body>
