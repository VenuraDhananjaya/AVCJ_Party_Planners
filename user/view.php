...
$total=($cake_price*$cpieces)+$photo_price+$video_price+($t_price*$tamount)+($c_price*$camount)+($tent_price*$tentamount)+$venues_price+$music_price +$deco_price+($ftotal*$plates);
...
if(isset($_POST['pros'])){
	 global $total, $eventid;
	 $total=(int)$total;
	$sql="UPDATE event SET budget='$total' WHERE eventid = $eventid";
...
<form action="view.php" method="post">
		<button type="submit" name="pros">Proceed</button>
</form>
