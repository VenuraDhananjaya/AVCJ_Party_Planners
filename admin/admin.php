...
<table style="margin-right: auto;margin-left: auto;">
	<td>
		<div class="admin">
			<form action="admin.php" method="post" name="photog" onsubmit="return ratecheck1()" >
            ...
            <form action="admin.php" method="post" name="cake" onsubmit="return ratecheck2()">
                <p style="display: inline">Enter Name to delete or add: </p>
                <input type="text" name="name">
            ...
            <form action="admin.php" method="post" name="tables" onsubmit="return ratecheck3()">
            ...
            <form action="admin.php" method="post" name="venue" onsubmit="return ratecheck4()">
            ...
            <form action="admin.php" method="post" name="music" onsubmit="return ratecheck5()">
            ...
            <form action="admin.php" method="post" name="deco" onsubmit="return ratecheck7()">
            ...
            <form action="admin.php" method="post" name="food" onsubmit="return ratecheck8()">
